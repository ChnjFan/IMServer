...
inline constexpr ChatServiceRsp::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        json_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
template <typename>
PROTOBUF_CONSTEXPR ChatServiceRsp::ChatServiceRsp(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(ChatServiceRsp_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
struct ChatServiceRspDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ChatServiceRspDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~ChatServiceRspDefaultTypeInternal() {}
  union {
    ChatServiceRsp _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChatServiceRspDefaultTypeInternal _ChatServiceRsp_default_instance_;

inline constexpr ChatServiceReq::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        json_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
template <typename>
PROTOBUF_CONSTEXPR ChatServiceReq::ChatServiceReq(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(ChatServiceReq_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
struct ChatServiceReqDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ChatServiceReqDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~ChatServiceReqDefaultTypeInternal() {}
  union {
    ChatServiceReq _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChatServiceReqDefaultTypeInternal _ChatServiceReq_default_instance_;
}  // namespace message
...
const ::uint32_t
    TableStruct_message_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceReq, _impl_.to_uid_),
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceReq, _impl_.json_),
        1,
        2,
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceRsp, _impl_._has_bits_),
        7, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceRsp, _impl_.error_),
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceRsp, _impl_.from_uid_),
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceRsp, _impl_.to_uid_),
        PROTOBUF_FIELD_OFFSET(::message::ChatServiceRsp, _impl_.json_),
        1,
        2,
        3,
        0,
...
class ChatServiceReq::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<ChatServiceReq>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_._has_bits_);
};

ChatServiceReq::ChatServiceReq(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ChatServiceReq_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:message.ChatServiceReq)
}
PROTOBUF_NDEBUG_INLINE ChatServiceReq::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::message::ChatServiceReq& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        json_(arena, from.json_) {}

ChatServiceReq::ChatServiceReq(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena,
    const ChatServiceReq& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ChatServiceReq_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  ChatServiceReq* const _this = this;
  (void)_this;
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ...
  // @@protoc_insertion_point(copy_constructor:message.ChatServiceReq)
}
PROTOBUF_NDEBUG_INLINE ChatServiceReq::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
inline void ChatServiceReq::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
  ::memset(reinterpret_cast<char *>(&_impl_) +
               offsetof(Impl_, from_uid_),
           0,
...
ChatServiceReq::~ChatServiceReq() {
  // @@protoc_insertion_point(destructor:message.ChatServiceReq)
  SharedDtor(*this);
}
inline void ChatServiceReq::SharedDtor(MessageLite& self) {
  ChatServiceReq& this_ = static_cast<ChatServiceReq&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
...
inline void* PROTOBUF_NONNULL ChatServiceReq::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) ChatServiceReq(arena);
}
constexpr auto ChatServiceReq::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ChatServiceReq),
                                            alignof(ChatServiceReq));
}
constexpr auto ChatServiceReq::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          &_ChatServiceReq_default_instance_._instance,
          &_table_.header,
          nullptr,  // OnDemandRegisterArenaDtor
          nullptr,  // IsInitialized
          &ChatServiceReq::MergeImpl,
          ::google::protobuf::Message::GetNewImpl<ChatServiceReq>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &ChatServiceReq::SharedDtor,
          ::google::protobuf::Message::GetClearImpl<ChatServiceReq>(), &ChatServiceReq::ByteSizeLong,
              &ChatServiceReq::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
          PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_._cached_size_),
          false,
      },
      &ChatServiceReq::kDescriptorMethods,
      &descriptor_table_message_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ChatServiceReq_class_data_ =
        ChatServiceReq::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
ChatServiceReq::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&ChatServiceReq_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(ChatServiceReq_class_data_.tc_table);
  return ChatServiceReq_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 0, 35, 2>
ChatServiceReq::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_._has_bits_),
    0, // no _extensions_
    3, 24,  // max_field_number, fast_idx_mask
    offsetof(decltype(_table_), field_lookup_table),
    4294967288,  // skipmap
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    ChatServiceReq_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::message::ChatServiceReq>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
    // int32 from_uid = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatServiceReq, _impl_.from_uid_), 1>(),
     {8, 1, 0, PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.from_uid_)}},
    // int32 to_uid = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatServiceReq, _impl_.to_uid_), 2>(),
     {16, 2, 0, PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.to_uid_)}},
    // string json = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 0, 0, PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.json_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 from_uid = 1;
    {PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.from_uid_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 to_uid = 2;
    {PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.to_uid_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string json = 3;
    {PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.json_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
PROTOBUF_NOINLINE void ChatServiceReq::Clear() {
// @@protoc_insertion_point(message_clear_start:message.ChatServiceReq)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL ChatServiceReq::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
  const ChatServiceReq& this_ = static_cast<const ChatServiceReq&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* PROTOBUF_NONNULL ChatServiceReq::_InternalSerialize(
    ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) const {
  const ChatServiceReq& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:message.ChatServiceReq)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_json().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.ChatServiceReq.json");
      target = stream->WriteStringMaybeAliased(3, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.ChatServiceReq)
  return target;
}

#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t ChatServiceReq::ByteSizeLong(const MessageLite& base) {
  const ChatServiceReq& this_ = static_cast<const ChatServiceReq&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::size_t ChatServiceReq::ByteSizeLong() const {
  const ChatServiceReq& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:message.ChatServiceReq)
  ::size_t total_size = 0;
...
void ChatServiceReq::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  auto* const _this = static_cast<ChatServiceReq*>(&to_msg);
  auto& from = static_cast<const ChatServiceReq&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:message.ChatServiceReq)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ChatServiceReq::CopyFrom(const ChatServiceReq& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:message.ChatServiceReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ChatServiceReq::InternalSwap(ChatServiceReq* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.to_uid_)
      + sizeof(ChatServiceReq::_impl_.to_uid_)
      - PROTOBUF_FIELD_OFFSET(ChatServiceReq, _impl_.from_uid_)>(
          reinterpret_cast<char*>(&_impl_.from_uid_),
          reinterpret_cast<char*>(&other->_impl_.from_uid_));
}

::google::protobuf::Metadata ChatServiceReq::GetMetadata() const {
  return ::google::protobuf::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================

class ChatServiceRsp::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<ChatServiceRsp>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_._has_bits_);
};

ChatServiceRsp::ChatServiceRsp(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ChatServiceRsp_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:message.ChatServiceRsp)
}
PROTOBUF_NDEBUG_INLINE ChatServiceRsp::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::message::ChatServiceRsp& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        json_(arena, from.json_) {}

ChatServiceRsp::ChatServiceRsp(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena,
    const ChatServiceRsp& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ChatServiceRsp_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  ChatServiceRsp* const _this = this;
  (void)_this;
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ...
  // @@protoc_insertion_point(copy_constructor:message.ChatServiceRsp)
}
PROTOBUF_NDEBUG_INLINE ChatServiceRsp::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
inline void ChatServiceRsp::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
  ::memset(reinterpret_cast<char *>(&_impl_) +
               offsetof(Impl_, error_),
           0,
...
ChatServiceRsp::~ChatServiceRsp() {
  // @@protoc_insertion_point(destructor:message.ChatServiceRsp)
  SharedDtor(*this);
}
inline void ChatServiceRsp::SharedDtor(MessageLite& self) {
  ChatServiceRsp& this_ = static_cast<ChatServiceRsp&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
  this_._impl_.json_.Destroy();
  this_._impl_.~Impl_();
...
inline void* PROTOBUF_NONNULL ChatServiceRsp::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) ChatServiceRsp(arena);
}
constexpr auto ChatServiceRsp::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ChatServiceRsp),
                                            alignof(ChatServiceRsp));
}
constexpr auto ChatServiceRsp::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          &_ChatServiceRsp_default_instance_._instance,
          &_table_.header,
          nullptr,  // OnDemandRegisterArenaDtor
          nullptr,  // IsInitialized
          &ChatServiceRsp::MergeImpl,
          ::google::protobuf::Message::GetNewImpl<ChatServiceRsp>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &ChatServiceRsp::SharedDtor,
          ::google::protobuf::Message::GetClearImpl<ChatServiceRsp>(), &ChatServiceRsp::ByteSizeLong,
              &ChatServiceRsp::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
          PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_._cached_size_),
          false,
      },
      &ChatServiceRsp::kDescriptorMethods,
      &descriptor_table_message_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ChatServiceRsp_class_data_ =
        ChatServiceRsp::InternalGenerateClassData_();

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
ChatServiceRsp::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&ChatServiceRsp_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(ChatServiceRsp_class_data_.tc_table);
  return ChatServiceRsp_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 4, 0, 35, 2>
ChatServiceRsp::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_._has_bits_),
    0, // no _extensions_
    4, 24,  // max_field_number, fast_idx_mask
    offsetof(decltype(_table_), field_lookup_table),
    4294967280,  // skipmap
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    ChatServiceRsp_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::message::ChatServiceRsp>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string json = 4;
    {::_pbi::TcParser::FastUS1,
     {34, 0, 0, PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.json_)}},
    // int32 error = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatServiceRsp, _impl_.error_), 1>(),
     {8, 1, 0, PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.error_)}},
    // int32 from_uid = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatServiceRsp, _impl_.from_uid_), 2>(),
     {16, 2, 0, PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.from_uid_)}},
    // int32 to_uid = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatServiceRsp, _impl_.to_uid_), 3>(),
     {24, 3, 0, PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.to_uid_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 error = 1;
    {PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.error_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 from_uid = 2;
    {PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.from_uid_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // int32 to_uid = 3;
    {PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.to_uid_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // string json = 4;
    {PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.json_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
PROTOBUF_NOINLINE void ChatServiceRsp::Clear() {
// @@protoc_insertion_point(message_clear_start:message.ChatServiceRsp)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL ChatServiceRsp::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
  const ChatServiceRsp& this_ = static_cast<const ChatServiceRsp&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* PROTOBUF_NONNULL ChatServiceRsp::_InternalSerialize(
    ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) const {
  const ChatServiceRsp& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:message.ChatServiceRsp)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_json().empty()) {
      const ::std::string& _s = this_._internal_json();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.ChatServiceRsp.json");
      target = stream->WriteStringMaybeAliased(4, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.ChatServiceRsp)
  return target;
}

#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t ChatServiceRsp::ByteSizeLong(const MessageLite& base) {
  const ChatServiceRsp& this_ = static_cast<const ChatServiceRsp&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::size_t ChatServiceRsp::ByteSizeLong() const {
  const ChatServiceRsp& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:message.ChatServiceRsp)
  ::size_t total_size = 0;
...
void ChatServiceRsp::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  auto* const _this = static_cast<ChatServiceRsp*>(&to_msg);
  auto& from = static_cast<const ChatServiceRsp&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:message.ChatServiceRsp)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ChatServiceRsp::CopyFrom(const ChatServiceRsp& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:message.ChatServiceRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ChatServiceRsp::InternalSwap(ChatServiceRsp* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.json_, &other->_impl_.json_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.to_uid_)
      + sizeof(ChatServiceRsp::_impl_.to_uid_)
      - PROTOBUF_FIELD_OFFSET(ChatServiceRsp, _impl_.error_)>(
          reinterpret_cast<char*>(&_impl_.error_),
          reinterpret_cast<char*>(&other->_impl_.error_));
}

::google::protobuf::Metadata ChatServiceRsp::GetMetadata() const {
  return ::google::protobuf::Message::GetMetadataImpl(GetClassData()->full());
}
